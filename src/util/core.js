...
export async function download (url) {
  ...
  const writer = new sb.WritableStreamBuffer({
...
export async function untar (target, buffer) {
  const reader = new sb.ReadableStreamBuffer();
